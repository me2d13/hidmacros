{ 14/02/2007 08:40:52 (GMT+0:00) > [Akadamia] checked in   }
{ 14/02/2007 08:40:50 (GMT+0:00) > [Akadamia] checked in   }
...
program TrackingErrors;

uses
  Forms,
  TEU in 'TEU.pas' {TrackingErrorsForm},
...
begin
  ...
  Application.CreateForm(TTrackingErrorsForm, TrackingErrorsForm);
  Application.Run;
end.
