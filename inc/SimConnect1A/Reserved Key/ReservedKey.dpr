{ 08/02/2007 14:08:49 (GMT+0:00) > [Akadamia] checked in   }
{ 08/02/2007 14:08:48 (GMT+0:00) > [Akadamia] checked in   }
...
uses
  Forms,
  RKU in 'RKU.pas' {ReservedKeyForm},
...
begin
  ...
  Application.CreateForm(TReservedKeyForm, ReservedKeyForm);
  Application.Run;
end.
