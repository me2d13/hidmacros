...
{ 08/02/2007 14:06:17 (GMT+0:00) > [Akadamia] checked in   }
...
program VariableStrings;

uses
  Forms,
  VSU in 'VSU.pas' {VariableStringsForm},
...
begin
  ...
  Application.CreateForm(TVariableStringsForm, VariableStringsForm);
  Application.Run;
end.
