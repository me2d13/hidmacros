{ 12/02/2007 10:24:34 (GMT+0:00) > [Akadamia] checked in   }
{ 12/02/2007 10:24:34 (GMT+0:00) > [Akadamia] checked in   }
{ 08/02/2007 14:07:55 (GMT+0:00) > [Akadamia] checked in   }
{ 08/02/2007 14:07:55 (GMT+0:00) > [Akadamia] checked in   }
...
program MenuItemsExtended;

uses
  Forms,
  MIUe in 'MIUe.pas' {MenuItemsForm},
  SimConnectRT in '..\Header\SimConnectRT.pas';

{$R *.res}

begin
  Application.Initialize;
  Application.CreateForm(TMenuItemsForm, MenuItemsForm);
  Application.Run;
end.
