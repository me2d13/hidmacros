...
uses
  Forms,
  TMUS in 'TMUS.pas' {TextMenuForm},
  SimConnectSupport in '..\HeaderStandard\SimConnectSupport.pas',
  SimConnect in '..\HeaderStandard\SimConnect.pas';

{$R *.res}

begin
  Application.Initialize;
  Application.CreateForm(TTextMenuForm, TextMenuForm);
  Application.Run;
end.
