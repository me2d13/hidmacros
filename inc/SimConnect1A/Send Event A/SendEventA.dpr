{ 08/02/2007 14:10:11 (GMT+0:00) > [Akadamia] checked in   }
{ 08/02/2007 14:10:10 (GMT+0:00) > [Akadamia] checked in   }
...
uses
  Forms,
  SEAU in 'SEAU.pas' {SendEventAForm},
...
begin
  ...
  Application.CreateForm(TSendEventAForm, SendEventAForm);
  Application.Run;
end.
