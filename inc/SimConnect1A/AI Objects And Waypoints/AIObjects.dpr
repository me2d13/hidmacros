{ 08/02/2007 14:11:52 (GMT+0:00) > [Akadamia] checked in   }
{ 08/02/2007 14:05:19 (GMT+0:00) > [Akadamia] checked in   }
...
begin
  ...
  Application.CreateForm(TAIObjectsForm, AIObjectsForm);
  Application.Run;
end.
