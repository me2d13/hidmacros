{ 08/02/2007 14:07:16 (GMT+0:00) > [Akadamia] checked in   }
...
program DialogBoxMode;

uses
  Forms,
  DBMU in 'DBMU.pas' {DialogBoxModeForm},
...
begin
  ...
  Application.CreateForm(TDialogBoxModeForm, DialogBoxModeForm);
  Application.Run;
end.
