{ 14/02/2007 08:50:16 (GMT+0:00) > [Akadamia] checked in   }
{ 14/02/2007 08:50:15 (GMT+0:00) > [Akadamia] checked in   }
...
program ThrottleControl;

uses
  Forms,
  TCU in 'TCU.pas' {ThrottleControlForm},
...
begin
  ...
  Application.CreateForm(TThrottleControlForm, ThrottleControlForm);
  Application.Run;
end.
