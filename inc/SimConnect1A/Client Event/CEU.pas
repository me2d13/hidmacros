{ 25/05/2007 10:28:06 (GMT+1:00) > [Akadamia] checked in   }
{ 25/05/2007 10:27:46 (GMT+1:00) > [Akadamia] checked out /}
{ 14/02/2007 08:27:47 (GMT+0:00) > [Akadamia] checked in   }
{ 14/02/2007 08:27:21 (GMT+0:00) > [Akadamia] checked out /}
{ 12/02/2007 10:10:47 (GMT+0:00) > [Akadamia] checked in   }
{ 08/02/2007 14:06:49 (GMT+0:00) > [Akadamia] checked in   }
{-----------------------------------------------------------------------------
 Unit Name: CEU
 Author:    ken.adam
 Date:      15-Jan-2007
 Purpose:   Translation of Client Event example to Delphi
...
var
  ClientEventForm       : TClientEventForm;
...
procedure MyDispatchProc(pData: PSimConnectRecv; cbData: DWORD; pContext:
  Pointer); stdcall;
begin
  ClientEventForm.DispatchHandler(pData, cbData, pContext);
end;
...
procedure TClientEventForm.DispatchHandler(pData: PSimConnectRecv; cbData:
  DWORD;
  pContext: Pointer);
var
...
procedure TClientEventForm.FormCloseQuery(Sender: TObject;
...
procedure TClientEventForm.FormCreate(Sender: TObject);
begin
...
procedure TClientEventForm.SimConnectMessage(var Message: TMessage);
begin
...
procedure TClientEventForm.StartEventExecute(Sender: TObject);
var
  hr                : HRESULT;
begin
  if (SUCCEEDED(SimConnect_Open(hSimConnect, 'Client Event', Handle,
...
procedure TClientEventForm.StartPollExecute(Sender: TObject);
var
  hr                : HRESULT;
begin
