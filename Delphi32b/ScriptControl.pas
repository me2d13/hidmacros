...
s  TLogCallbackProcedure = procedure(pMessage: String) of object;
  ...
  private
    ...
    fOnClientLog: TLogCallbackProcedure;
  ...
  public
    ...
    property OnClientLog: TLogCallbackProcedure read fOnClientLog write fOnClientLog;
  end;
...
procedure MyDispatchProc(pData: PSimConnectRecv; cbData: DWORD; pContext:
  Pointer); stdcall;
begin
  FSX.DispatchHandler(pData, cbData, pContext);
end;
  ...
  case TSimConnectRecvId(pData^.dwID) of
    ...
    SIMCONNECT_RECV_ID_EVENT:
      begin
        ...
        DebugLog('SC Event ' + IntToStr(evt^.uEventID) + ', data ' + IntToStr(evt^.dwData));
      end;
    ...
    DebugLog(Format('Unknown dwID: %d', [pData.dwID]));
  end;
end;
...
procedure TFSXcontrol.AddEvents(l : TStrings);
begin
