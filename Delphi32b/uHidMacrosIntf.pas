...
uses ComServ, SysUtils, Windows, FSXControl, FSUIPCcontrol,
     uGlobals, uGameDevices, uXplControl, uSendKeys, uXplCommon;
  //, MPlayer;
...
function THIDMacrosIntf.GetTriggerDevice: OleVariant;
begin

end;

function THIDMacrosIntf.GetTriggerDirection: OleVariant;
begin

end;

function THIDMacrosIntf.GetTriggerItem: OleVariant;
begin
...
procedure THIDMacrosIntf.XPLMessage(const Message: WideString);
begin
  Glb.Xpl.DrawText(Message);
end;

procedure THIDMacrosIntf.XPLMessageAt(const Message: WideString;
  Position: Double);
begin
  Glb.Xpl.DrawText(Message, Position);
end;

procedure THIDMacrosIntf.XPLMessageAtFor(const Message: WideString;
  YPos: Double; Timeout: SYSINT);
begin
  Glb.Xpl.DrawText(Message, YPos, Timeout);
end;

procedure THIDMacrosIntf.XPLSwitchNextDataref(const pDataref,
  pValues: WideString);
begin
  Glb.Xpl.ToggleDataRef(pDataRef, pValues, HDMC_SWITCH_NEXT);
end;

procedure THIDMacrosIntf.XPLSwitchPreviousDataref(const pDataref,
  pValues: WideString);
begin
  Glb.Xpl.ToggleDataRef(pDataRef, pValues, HDMC_SWITCH_PREVIOUS);
end;

procedure THIDMacrosIntf.XPLToggleNextDataref(const pDataRef,
  pValues: WideString);
begin
  Glb.Xpl.ToggleDataRef(pDataRef, pValues, HDMC_TOGGLE_NEXT);
end;

procedure THIDMacrosIntf.XPLTogglePreviousDataref(const pDataRef,
  pValues: WideString);
begin
  Glb.Xpl.ToggleDataRef(pDataRef, pValues, HDMC_TOGGLE_PREVIOUS);
end;
